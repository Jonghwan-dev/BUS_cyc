...
class SplitDataset(BaseDataset):
    """This dataset class can load unaligned/unpaired datasets with train/val/test split."""
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, 'LR')  # create a path '/path/to/data/LR'
        self.dir_B = os.path.join(opt.dataroot, 'HR')  # create a path '/path/to/data/HR'

        self.A_paths = sorted(make_dataset(self.dir_A, opt.max_dataset_size))   # load images from '/path/to/data/LR'
        self.B_paths = sorted(make_dataset(self.dir_B, opt.max_dataset_size))    # load images from '/path/to/data/HR'
